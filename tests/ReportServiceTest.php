...
final class ReportServiceTest extends TestCase
{
    ...
    {
        $this->db=new PDO('sqlite::memory:');$this->db->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);$this->db->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE,PDO::FETCH_ASSOC);$this->db->exec((string)file_get_contents(dirname(__DIR__).'/apps/preconselho-web/database/migrations/001_initial.sql'));
