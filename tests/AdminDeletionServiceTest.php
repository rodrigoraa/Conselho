...
final class AdminDeletionServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->db->exec("INSERT INTO professores(id,usuario_id)VALUES(1,2);
            ...
            INSERT INTO vinculos_professor_turma(id,professor_id,turma_externa_id,turma_nome_snapshot,turma_ano_letivo_snapshot,turno)VALUES(1,1,10,'7º A',2026,'MATUTINO');
    ...
    public function testAdminCanDeleteClassBindingWithoutErasingLegacyHistory(): void
    {
        ...
        self::assertSame(1,(int)$this->db->query('SELECT COUNT(*) FROM relatorios_pre_conselho')->fetchColumn());
        self::assertSame(1,(int)$this->db->query('SELECT COUNT(*) FROM relatorio_alunos')->fetchColumn());
        self::assertSame(1,(int)$this->db->query('SELECT COUNT(*) FROM historico_status_relatorio')->fetchColumn());
