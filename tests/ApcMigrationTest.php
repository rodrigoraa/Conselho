...
final class ApcMigrationTest extends ApcTestCase
{
    public function testCreatesApcSchemaInSeparateDatabaseWithExpectedIndexesAndParameters(): void
    {
        ...
        self::assertSame(['apc_anexos','apc_auditoria','apc_entregas','apc_eventos','apc_parametros','apc_planos'],$tables);self::assertSame(3,(int)$db->query('SELECT COUNT(*) FROM apc_parametros')->fetchColumn());
    }
