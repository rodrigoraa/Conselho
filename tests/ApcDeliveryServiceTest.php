...
use Apc\Services\{AuthorizationService,DeliveryService};
use PreConselho\Integration\SecretariaApiClient;
use Shared\Exceptions\HttpException;

final class ApcDeliveryServiceTest extends ApcTestCase
{
    private function service(?SecretariaApiClient $api=null): array
    {
        ...
        return[$apc,$deliveries,new DeliveryService($plans,$deliveries,new SettingsRepository($apc),new AuditRepository($apc),$authorization,$api)];
    }
