...
<section class="portal-grid" aria-label="Sistemas disponíveis">
    ...
    <article class="card portal-card apc-card"><span class="portal-icon" aria-hidden="true">APC</span><div><p class="eyebrow">Planejamento e comprovação</p><h2>APCs</h2><p><strong>Atividades Pedagógicas Complementares</strong><br>Planos de ação, entregas, anexos privados e acompanhamento.</p></div><a class="button primary" href="/apc">Acessar APCs <span aria-hidden="true">→</span></a></article>
</section>
